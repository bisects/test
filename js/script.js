function privscope(){
  ...
  */
  ...
  const colors = ["purple", "blessed", "yellow", "allah", "red", "blue", "green", "pink", "brown", "orange", "black", "jew", "floyd", "cyan", "white", "king", "pope", "rabbi", "peedy", "clippy", "troll", "jabba"];
  ...
  function closelog(){
      ...
      $("logshow").style.display = "inline-block";
      minx = 0;
  }
  ...
  function changeSettings(crosscolors, bg, autojoin, name, theme, color){
      ...
      settings.theme = (theme.startsWith("http") && !theme.includes("server.erik.red")) ? theme : "/themes/"+theme+".css";
